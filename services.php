    ...
    <div class="blocgen">
      <div class="bloc8selling">
        <div class="paragraphe8chat ">
          ...
          <p>
            Chez LogExpress, nous mettons en relation les propriétaires et les acheteurs potentiels. Grâce à notre
            réseau
          ...
          <button class="bouton8contact8agent"><a href="contact.php">contacter agent</a></button>
        </div>
      ...
      <div class="bloc8location">
        ...
        <div class="paragraphe8location ">
          ...
          <p>Nous proposons un large choix de maisons, appartements, bureaux et magasins à louer dans plusieurs
            quartiers.
          ...
          <button class="bouton8contact8location"><a href="contact.php">contacter agent</a></button>
        </div>
      </div>
    ...
    <div class="div8gestion8gen">
      ...
      <div class="div8gestion">
        <p class="service-box dark">
          Confiez-nous la gestion complète de vos biens. De la recherche de locataires fiables à la gestion des
          paiements
        ...
        <p class="service-box light">
          Vous êtes promoteur ou investisseur ? Nous vous aidons à mettre en avant vos projets auprès du bon public.
          Grâce
          à notre visibilité en ligne et nos partenaires, vos biens atteignent plus rapidement des acheteurs ou
          locataires
          qualifiés.</p>
